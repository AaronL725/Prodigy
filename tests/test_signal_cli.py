...
def test_default_config_has_signal_section():
    ...
    assert cfg["signal"]["profit_hold_score_threshold"] == 0.2
    assert cfg["signal"]["loss_hold_score_threshold"] == 0.4
...
def test_build_signal_daemon_config_reads_thresholds():
    ...
    signal_cfg = {
        ...
        "profit_hold_score_threshold": 0.9,
        "loss_hold_score_threshold": 0.8,
    }
    cfg = build_signal_daemon_config(signal_cfg)

    assert cfg.total_notional_cap == 12345.0
    assert cfg.profit_hold_score_threshold == 0.9
    assert cfg.loss_hold_score_threshold == 0.8
